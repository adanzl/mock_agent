"""Qwen 模块总入口：外部只调用本文件，内部分发至 Client / db_mgr。"""
...
__all__ = ["QwenMgr", "qwen_mgr"]


class QwenMgr:
    """Qwen 管理器（仿造 deepseek_mgr）。"""

    def _get_client(self):
        from app.services.qwen.client import get_client
    ...
    def list_conversations(
        self, *, provider: str = "qwen", limit: int = 50
    ) -> list[dict[str, Any]]:
